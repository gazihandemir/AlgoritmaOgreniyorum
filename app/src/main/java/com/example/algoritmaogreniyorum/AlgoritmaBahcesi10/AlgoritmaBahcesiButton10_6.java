...
public class AlgoritmaBahcesiButton10_6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_algoritma_bahcesi_button10_6);


    }

    public void cevapAlgo10_6_1(View view) {
    ...
    public void cevapAlgo10_6_2(View view) {
    ...
    public void cevapAlgo10_6_3(View view) {
        LayoutInflater inflater = getLayoutInflater();
        View layout = inflater.inflate(R.layout.toast_layout2,
                (ViewGroup) findViewById(R.id.custom_toast_container));
    ...
    // true
    public void cevapAlgo10_6_4(View view) {
        LayoutInflater inflater = getLayoutInflater();
