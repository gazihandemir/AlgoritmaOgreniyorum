...
public class AlgoritmaBahcesiButton7_11 extends AppCompatActivity {
    Button btnDevam;
    EditText edCevap;
    static String cevap = "ilkYari,ikinciYari";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_algoritma_bahcesi_button7_11);
        btnDevam = findViewById(R.id.btnDevamAlgo7_11);
        btnDevam.setVisibility(View.INVISIBLE);
        edCevap = findViewById(R.id.edCevapAlgo7_11);
    }

    public void calistirAlgo7_11(View view) {
    ...
    public void devamAlgo7_11(View view) {
